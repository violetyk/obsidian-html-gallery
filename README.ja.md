...
モバイルには縦のリボンバーがありません。ナビゲーションメニューのリボンボタンをタップして一覧から選ぶか、コマンドパレットから開いてください。設定 → 外観 の「Quick access ribbon item」でこのプラグインを選ぶと、リボンボタンから直接開けます。ファイルエクスプローラーでフォルダを長押しすると、右クリックと同じメニューが出ます。
